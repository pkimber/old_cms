...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.send_create_signal(u'cms', ['Content'])

        # Adding unique constraint on 'Content', fields ['section', 'moderate_state']
        db.create_unique(u'cms_content', ['section_id', 'moderate_state_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Content', fields ['section', 'moderate_state']
        db.delete_unique(u'cms_content', ['section_id', 'moderate_state_id'])

        # Deleting model 'Content'
        db.delete_table(u'cms_content')
    ...
    models = {
        ...
        u'cms.content': {
            'Meta': {'unique_together': "(('section', 'moderate_state'),)", 'object_name': 'Content'},
        ...
        u'cms.section': {
            'Meta': {'ordering': "['page', 'modified']", 'object_name': 'Section'},
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'date_moderated': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'description': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
