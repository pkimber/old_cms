...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'cms_simplecontent', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('content', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['cms.Content'], unique=True)),
        ...
        db.send_create_signal(u'cms', ['SimpleContent'])


    def backwards(self, orm):
        # Deleting model 'SimpleContent'
        db.delete_table(u'cms_simplecontent')
