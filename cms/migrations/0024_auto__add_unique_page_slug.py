...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_unique(u'cms_page', ['slug'])


    def backwards(self, orm):
        # Removing unique constraint on 'Page', fields ['slug']
        db.delete_unique(u'cms_page', ['slug'])
    ...
    models = {
        ...
        u'cms.content': {
            'Meta': {'ordering': "['section__page__name', 'order', 'moderate_state__slug']", 'unique_together': "(('section', 'moderate_state'),)", 'object_name': 'Content'},
